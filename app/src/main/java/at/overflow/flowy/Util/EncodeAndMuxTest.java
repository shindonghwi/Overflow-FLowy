...
import static at.overflow.flowy.Provider.SurfaceTextureProvider.screenSurface;
import static at.overflow.flowy.Util.Constants.textureArray;
...
public class EncodeAndMuxTest {
    ...
    private void initVideoEncoder() {
        ...
        //-----------------输出文件路径-----------------------
        // 输出文件路径
        String outputPath = new File(Environment.getExternalStorageDirectory().toString() + "/Flowy/test.mp4").toString();
